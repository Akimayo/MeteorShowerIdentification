...
\begin{document}
    ...
    \begin{todolist}
        ...
        \begin{todolist}
            \item Fotografická měření \todo{Ceplecha}
            \item Elementy dráhy \note{$q/a$, $e$, $i$, $\omega$, \NorthNode, $\nu$} \cite[743--744]{newapproach}
        \end{todolist}
    ...
    \note{\textbf{...Comet and Meteor Showe Association} \cite{cometassoc}: příslušnost některých meteorických rojů kometám, tabulka elementů dráhy těchto komet, poznámky k $D_\text{SH}$, lepší rozpis $D_\text{D}$}\\
