...
\begin{figure}[ht]
    \centering
    \subfigure[vzdálenosti perihelia $q$]{\includegraphics[width=0.4\linewidth]{img/remarks-q.png}\label{img:revised:jopek:1}}\hfill
    \subfigure[excentricity $e$]{\includegraphics[width=0.4\linewidth]{img/remarks-e.png}\label{img:revised:jopek:2}}
