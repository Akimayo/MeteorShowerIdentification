...
from lib.io import preload, get_output_file, release_output_file, release_reference_file, release_compared_file
...
try:
    ...
    match options['action']:
        ...
        case _:
            ...
            output = get_output_file(options)
            start = time()
            match options['action']:
                case 'compare_single':
            ...
            release_compared_file()
            release_reference_file()
